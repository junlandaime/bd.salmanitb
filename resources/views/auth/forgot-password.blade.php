...
@section('title', 'Lupa Password - Bidang Dakwah Masjid Salman ITB')
...
<div class="w-full max-w-md mx-auto">
    ...
    <div class="text-center mb-8">
        ...
        <h1 class="text-xl font-extrabold text-white">Lupa Password?</h1>
    ...
    {{-- Session Status --}}
    @if(session('status'))
        <div class="mb-6 flex items-center gap-3 px-4 py-3 rounded-xl bg-emerald-500/10 border border-emerald-400/30 text-emerald-300 text-xs font-medium">
