    ...
    <div class="bg-white rounded-lg shadow-md p-6">
        <form action="{{ route('admin.batch-alumni.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="instagram_account" id="instagram_account" value="{{ old('instagram_account') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50 @error('instagram_account') border-red-500 @enderror">
            ...
            <div class="mb-4">
                ...
                <textarea name="notes" id="notes" rows="3" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50 @error('notes') border-red-500 @enderror">{{ old('notes') }}</textarea>
                @error('notes')
                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                @enderror
            </div>
