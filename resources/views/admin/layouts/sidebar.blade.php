<nav class="mt-4 px-2 space-y-1">
    ...
    <a href="#"
        ...
        class="flex items-center px-4 py-2 rounded-md text-gray-700 hover:bg-gray-100 {{ request()->routeIs('admin.users.*') || request()->routeIs('admin.alumni.import.*') || request()->routeIs('admin.alumni.materials.import.*') ? 'bg-gray-100' : '' }}">
        <svg class="w-5 h-5 mr-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
            stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <div id="user-dropdown"
        class="pl-8 mt-1 {{ request()->routeIs('admin.users.*') || request()->routeIs('admin.alumni.import.*') || request()->routeIs('admin.alumni.materials.import.*') ? '' : 'hidden' }}">
