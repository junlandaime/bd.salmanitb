    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8 max-w-4xl">
        ...
        <div class="flex items-center justify-between mb-8">
            <div>
                ...
                <h1 class="text-2xl font-bold text-gray-900">Edit Artikel: {{ $article->title }}</h1>
                <p class="text-sm text-gray-500 mt-0.5">Perbarui konten artikel, kategori, gambar sampul, atau status publikasi.</p>
            </div>
