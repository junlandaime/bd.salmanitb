    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8 max-w-3xl">
        ...
        <div class="flex items-center justify-between mb-8">
            <div>
                ...
                <p class="text-sm text-gray-500 mt-0.5">Perbarui nama, email, password, atau peranan hak akses pengguna.</p>
            </div>
        ...
        <div class="bg-white rounded-2xl border border-gray-200/80 shadow-sm p-6 sm:p-8">
            <form action="{{ route('admin.users.update', $user) }}" method="POST" class="space-y-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                        <label for="password_confirmation" class="block text-xs font-semibold text-gray-700 mb-1">Konfirmasi Password Baru</label>
                ...
                <div class="pt-2 border-t border-gray-100">
                    <div class="flex items-center justify-between mb-2">
                        ...
                        <span class="text-[11px] text-gray-400 font-normal">Hapus semua centang jika ingin user tanpa role (Pendaftar)</span>
                    </div>
