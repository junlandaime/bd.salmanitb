...
@section('title', 'Edit Materi: ' . $material->title . ' - Admin Panel')
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
        <div>
            <div class="flex items-center gap-2 text-xs text-gray-500 mb-2">
                ...
                <span>/</span>
                <span class="text-gray-700 font-medium">Edit Materi</span>
            </div>
            <h1 class="text-2xl font-bold text-gray-900">Edit Materi Pembelajaran</h1>
        ...
        <div class="bg-white rounded-2xl border border-gray-200/80 shadow-sm p-6 sm:p-8">
            <div class="flex items-center gap-3 pb-5 border-b border-gray-100 mb-6">
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-500">Ubah judul materi pembelajaran, deskripsi silabus, dan urutan materi.</p>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div class="sm:col-span-2">
                    ...
                    <textarea name="description" id="description" rows="3"
                        ...
                        placeholder="Uraian singkat mengenai poin-poin utama materi ini...">{{ old('description', $material->description) }}</textarea>
                    @error('description')
                        <p class="mt-1 text-xs text-red-600 font-medium">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <div class="relative rounded-xl shadow-xs">
                        <input type="number" name="order" id="order" value="{{ old('order', $material->order) }}" min="1" required
