...
@section('title', 'Ubah Artikel - Panel Penulis')
...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="text-xs sm:text-sm text-gray-500 mt-0.5">Perbarui isi, gambar, kategori, atau status publikasi artikel.</p>
        </div>
    ...
    <form action="{{ route('author.articles.update', $article) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        @method('PUT')
