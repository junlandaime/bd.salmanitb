    ...
    <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
                ...
                <ul class="space-y-2">
                    <li><a href="{{ route('home') }}" class="text-gray-700 hover:text-gray-900 text-sm">Beranda</a></li>
                ...
                <ul class="space-y-4">
                    ...
                    <li class="flex items-center space-x-3">
                        ...
                        <a href="mailto:info@salmanitb.com"
                            class="text-gray-700 hover:text-gray-900 text-sm">info@salmanitb.com</a>
                    </li>
                    <li class="flex items-center space-x-3">
                        <svg class="h-6 w-6 text-gray-700 flex-shrink-0" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor">
                        ...
                        <a href="tel:+6222-2500935" class="text-gray-700 hover:text-gray-900 text-sm">+62
                            22-2500935</a>
                    </li>
                    <li class="mt-4">
