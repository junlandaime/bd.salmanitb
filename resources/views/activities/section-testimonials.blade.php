    ...
    <div class="container mx-auto px-4">
        ...
        <div class="max-w-5xl mx-auto" x-data="{ activeSlide: 0 }">
            <div class="relative rounded-xl overflow-hidden shadow-xl bg-white">
                            ...
                            <div class="min-w-full grid grid-cols-1 md:grid-cols-5 items-center">
                                <div class="md:col-span-2 h-full">
                                    <img src="{{ Storage::url($testimonial->image) }}"
                                        alt="Testimonial {{ $index + 1 }}" class="object-cover h-full w-full">
                                </div>
                                <div class="p-8 md:p-12 md:col-span-3">
                                    <svg class="text-green-200 fill-current w-12 h-12 mb-4"
                ...
                <!-- Controls -->
                <button
                    class="absolute top-1/2 left-4 transform -translate-y-1/2 w-12 h-12 rounded-full bg-white shadow-lg flex items-center justify-center text-green-600 focus:outline-none"
                ...
                <button
                    class="absolute top-1/2 right-4 transform -translate-y-1/2 w-12 h-12 rounded-full bg-white shadow-lg flex items-center justify-center text-green-600 focus:outline-none"
